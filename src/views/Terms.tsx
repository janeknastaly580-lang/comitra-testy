...
/**
 * Pactista. Terms of Use for the SUBSCRIPTION / social-commitment model.
    ...
    <div className="phone-scroll h-full overflow-y-auto px-4 py-5">
      ...
      <Card className="mb-4 p-5">
        ...
        <p className="mt-3 text-sm leading-relaxed text-muted">
          Pactista is a goal-accountability app. You set a goal, a judge confirms whether
          you completed it, and if you don't, people you chose in advance (and who agreed) may receive
          a message. By using Pactista you agree to these Terms.
        </p>
      </Card>

      <div className="space-y-4">
        <Section n="1" title="Pactista is not gambling">
          <P>
            Pactista is <B>not</B> a game of chance and is not a gambling service. Nothing you do in
        ...
        <Section n="2" title="No money is staked on goals">
          <P>
            ...
            physical or material rewards</B> in Pactista. Completing a goal does not earn you money,
        ...
        <Section n="3" title="The subscription is a fee for using the app">
          <P>
            Pactista is offered as a subscription. New accounts get a free trial; after it, a
        ...
        <Section n="4" title="Keep goals action-based and appropriate">
          <P>
            Pactista is for personal goals: habits, study, work, projects, consistency and similar
            action-based commitments. Pactista should not be used to disclose especially private
        ...
        <Section n="5" title="Respect other people">
          <P>You may not use Pactista to:</P>
          <List
            items={[
        ...
        <Section n="9" title="Your responsibility for content">
          <P>
            You are responsible for the goals you create and the content you enter. Pactista may block
        ...
        <Section n="10" title="No professional advice">
          <P>
            Pactista does not provide medical, psychological, dietary/nutritional or legal advice, and
