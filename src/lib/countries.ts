/**
 * Full list of country international dialing codes, used by the phone-number
 * fields (judge / recipient contacts) so users pick a country instead of typing
 * the "+.." prefix by hand. `dial` includes the leading "+".
 */
export interface Country {
  /** ISO 3166-1 alpha-2 code (used as a stable key). */
  iso: string;
  name: string;
  /** International dialing code, e.g. "+48". */
  dial: string;
  /** Flag emoji (may not render on every platform, purely decorative). */
  flag: string;
}
...
/** Default country shown first in the picker. */
...
/** Combine a picked country and a national number into a full E.164-ish string. */
export function fullPhone(iso: string, nationalNumber: string): string {
